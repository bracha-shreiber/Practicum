...
namespace Resume.Service.Services
{
    public class AIService : IAIService
    {
        ...
        public async Task AddAiResponseAsync(IFormFile resumeFile, string extention, int userId)
        {
            ...
            if (extention.Contains("pdf", StringComparison.OrdinalIgnoreCase))
            {
                ...
                await AnalyzeResumeAsync(resumeText, userId);
            }
        ...
        private async Task AnalyzeResumeAsync(string resumeText, int userId)
        {
            ...
            await _IaIRepository.AddAiResponseAsync(aiResponse, userId);
        }
